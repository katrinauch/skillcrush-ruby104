...
case number 
when 1
  message = "Your birth number is #{number}. \nOne is the leader. The number one indicates the ability to stand alone, and is a strong vibration. Ruled by the Sun."
when 2
...
when 9
  ...
  message = "Uh oh! Your birth number isn't 1-9!"
end
end

puts "When is you birthday? Please enter in this format: MMDDYYYY"
birthday = gets

number = get_birth_num(birthday)
